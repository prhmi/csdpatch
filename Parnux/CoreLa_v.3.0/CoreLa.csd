...
checkbox   bounds(144, 132, 15, 15) colour:0(100, 100, 100, 255)  channel("vlc") colour:1(100, 250, 60, 255)
...
iFrq chargah iBaseNote-2,iMidiNote
 ...
 aEnv transeg 0, 0.0001,4, 0.3, p3-0.0001,-6, 0
 aSine    vco2    1,iFrq,0,0.2
...
schedulek "Empty",0,0.1,1
  ...
  elseif kVelOn == 1 && changed(kVelOn) == 1 then
