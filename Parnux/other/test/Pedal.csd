...
opcode SclArr, i[],i[]i
  ...
  while indx < iLen do
    ...
    iWrite = iWrite + iArrIn[indx]
    iArrScal [indx] = iWrite*iN
  indx += 1
  od
xout iArrScal
endop
...
instr NoteTriger
  ...
  elseif iActive3 == 1 && iActive4 = 1 then
    iOctav    = 0
    iNumber   = 4 ;int(random:i(2, 5))
  elseif iActive3 == 2 && iActive4 = 1 then
    iOctav    = 0
    iNumber   = 2 ;int(random:i(1, 4))
   else
   iNumber = 0
   ;turnoff2 "NoteTriger",0,0
  ...
  ;print iActive4
      ...
      iRndIndx = iLen-1
      elseif iRndIndx == iNoteIndx then
      iRndIndx = 1
      endif
...
instr widget
	giVelocTable	ftgen	1, 0,   127, -7, 0, 80, 0.63, 47, 0.9
  ;schedule "scl",0,0.1
  Sin chnget "txta"
  kMidIn chnget "mid"
