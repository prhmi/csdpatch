...
; github.com/prhmi
<Cabbage>
form caption("Pan") size(300, 290)  guiMode("queue")  colour(0,0,0) style("legacy") pluginId("tpan")
...
combobox   bounds(166, 228, 57, 23), text("pan", "org","rnd"), channel("orgmd"), value(1), fontColour(255,255,255) colour(56, 63, 79, 255)
...
;aInL,aInR diskin "test2.wav",1,0,1
...
kSpeedMin = (kY+2.8)
kSpeedMax = (kZ+3)*3
kRndPan   jspline kRng, kSpeedMin, kSpeedMax
;printk 1/3,kSpeedMax
