...
nslider bounds(26, 152, 56, 32) range(0, 100, 70, 1, 1)  channel("mtromss") text("Metro ms") colour(56, 63, 79, 255)
nslider bounds(148, 10, 53, 25) range(10, 100, 10, 1, 1) velocity(50) channel("fde") text("Fade") colour(56, 63, 79, 255)

nslider bounds(128, 126, 46, 31), channel("stepsmin"), text("StepsMin"), range(1, 6, 2, 1, 1), colour(56, 63, 79, 255) valueTextBox(1) 
nslider bounds(176, 126, 45, 31), channel("stepsmax"), text("StepsMax"), range(4, 20, 10, 1, 1), colour(56, 63, 79, 255) valueTextBox(1) 
...
nslider bounds(266, 152, 56, 32) range(0, 1, 0.1, 1, .001) velocity(50) channel("swft") text("SWIFT") colour(56, 63, 79, 255)
