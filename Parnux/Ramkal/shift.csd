...
combobox   bounds(96, 190, 57, 20), text("Up", "Down"), channel("updown"), value(1),  colour(56, 63, 79, 255)
...
combobox   bounds(96, 212, 57, 20), text("Line", "Rnd", "timb"), channel("mod"), value(3),  colour(56, 63, 79, 255)
