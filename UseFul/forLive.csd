...
if changed(kDown) == 1 && kDown == 1 then
	...
	kCountEvent -= 1
	;;onOff events
	elseif kKey == 13 || kKey == 48  then
	schedulek "events",0,1, kCountEvent
	kEventsWrite = kCountEvent
	;;events numbers
	else
	kEventsWrite = kEvents
	schedulek "events",0,1,kEvents
	endif
endif
chnset kCountEvent, "previewEvents"
endin
...
<bsbPanel>
 ...
 <bsbObject version="2" type="BSBDisplay">
  <objectName>previewEvents</objectName>
  <x>19</x>
  <y>63</y>
  <width>160</width>
  <height>96</height>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>110</width>
  <height>30</height>
  <uuid>{8cc04c0d-df29-4398-b069-dfd74cacf8f8}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>-3</midicc>
  <description/>
 ...
 <bsbObject version="2" type="BSBDisplay">
  <objectName>lastEvent</objectName>
  <x>195</x>
  <y>110</y>
  <width>71</width>
  <height>48</height>
  <uuid>{806410c7-5375-496b-bdc2-7a5dba07171e}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>-3</midicc>
  <description/>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>100</width>
  <height>21</height>
  <uuid>{c9d032fe-505d-4356-95e8-c5e63c528762}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>-3</midicc>
  <description/>
  <label>Press + to increase</label>
  <alignment>left</alignment>
  <valignment>top</valignment>
  <font>Arial</font>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>100</width>
  <height>21</height>
  <uuid>{1f0188ba-3ea2-4359-afcf-1a116d8f79cc}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>-3</midicc>
  <description/>
  <label>Press - to decrease</label>
  <alignment>left</alignment>
  <valignment>top</valignment>
  <font>Arial</font>
  <fontsize>10</fontsize>
 ...
 <bsbObject version="2" type="BSBLabel">
  ...
  <width>100</width>
  <height>21</height>
  <uuid>{04fb48fd-a795-44b4-807c-137d52cb63c3}</uuid>
  <visible>true</visible>
  <midichan>0</midichan>
  <midicc>-3</midicc>
  <description/>
  <label>Press Enter to Trige</label>
  <alignment>left</alignment>
  <valignment>top</valignment>
  <font>Arial</font>
  <fontsize>10</fontsize>
